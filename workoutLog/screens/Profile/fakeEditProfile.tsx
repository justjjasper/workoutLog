...
//       try {
//         // let saveName, saveWeight, saveFeet, saveInches, savePhotoURI;

//         // tempWeight === weight? saveWeight = tempWeight : saveWeight = weight;
//         // tempHeight.feet === height.feet ? saveFeet = tempHeight.feet : saveFeet = height.feet;
//         // tempHeight.inches === height.inches ? saveInches = tempHeight.inches : saveInches = height.inches;
//         // tempPhotoURI === photoURI ? savePhotoURI = tempPhotoURI : savePhotoURI = photoURI;
...
//         photo_uri: tempPhotoURI
//       }

//       await axios.patch(`${LOCALTUNNEL}/saveProfileEdits`, payload)

//       // handleSetName(tempName);
//       // handleSetHeight(saveFeet, saveInches); //needs fixing, needs to be int
//       // handleSetWeight(saveWeight);
//       // handleSetPhotoURI(savePhotoURI)
//       navigation.goBack();
//     } catch(err) {
...
//         <Image
//           style={styles.image}
//           source= { tempPhotoURI !== '' ? {uri: tempPhotoURI} : ( photoURI === placeHolderImage? placeHolderImage : {uri: photoURI}) }
//         />
//         </TouchableOpacity>
...
//             <TextInput
//               value={ tempWeight.toString() !== '' ? tempWeight.toString() : (weight ? weight.toString() : '') }
...
//             <TextInput
//               style= {styles.pickerInput}
//               value= { tempHeight.feet.toString() !== '' ? tempHeight.feet.toString() : ( height.feet ? height.feet.toString() : '') }
//               keyboardType= 'numeric'
//               returnKeyType= {'done'}
...
//             <TextInput
//               style={styles.pickerInput}
//               value={tempHeight.inches.toString() !== '' ? tempHeight.inches.toString() : ( height.inches ? height.inches.toString() : '') }
...
// <Image
// style={styles.image}
// source= { placeHolderImage !== photoURI ? ( tempPhotoURI === '' ? require(placeHolderImage) : {uri: tempPhotoURI } ) : {uri: photoURI} }
// />

/*
*Profile  but not correct
   <Image
                source= { typeof photoURI === 'string' ? {uri: photoURI} : require(placeHolderImage)}
                style={styles.image}
              />
